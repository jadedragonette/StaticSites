...
#           gonna be here a while, might as well get comfortable...quick addition for the streak, and once again asn quick little thing just in case and again and again
            if item.startswith("# "):
                tag = h1
            if item.startswith("## "):
                tag = h2
